"""
Base Cipher Module - Provides abstract base classes for all cipher implementations.

This module defines a common interface for all cipher types, promoting
consistent behavior and making it easier to extend with new cipher implementations.
"""
