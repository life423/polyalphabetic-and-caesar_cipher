...
class CipherService(CipherService):
    ...
    def caesar_cipher(self, text, shift, encrypt=True):
        """
        Apply the Caesar cipher to the given text (backward compatibility method).
    ...
    def poly_alphabetic_cipher(self, text, keyword, encrypt=True):
        """
        Apply the Polyalphabetic cipher to the given text (backward compatibility method).
    ...
    def process_file(self, input_path, output_path, cipher_function):
        """
        Process a file through the specified cipher function (backward compatibility method).
        
        Args:
            input_path (str): Path to the input file
            output_path (str): Path to the output file
            cipher_function (callable): Function to apply to each line of the file
            
        Returns:
            str: A message indicating success or the error encountered
        """
        return self.process_file_with_cipher(input_path, output_path, cipher_function, True)
